...
# =============================================================================
# Derived from model_equations_MORDM.R. Adds a parallel-solver time-offset so
# one file covers both the sequential (Source/) and parallel (SourceCodeParallel/)
# solver stacks.
#
...
#
# Parallel solver switch
#   tOffset    Set to 0 for base (sequential) mode, 4 for parallel mode.
#              temp = t - tOffset is used in place of t for time-shifted equations.
#
...
temp = t - tOffset   # time offset: 0=base mode, 4=parallel mode
...
tOffset = 0                        #Time offset for parallel solver (0 = base, 4 = parallel: temp = t - tOffset)
