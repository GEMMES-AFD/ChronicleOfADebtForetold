...
cppMakeSys <- function(fileName=NULL, tderiv=NULL, parms=NULL, times=NULL, 
	...
	# write.table(sys$tderiv,file="tdriv.csv",sep=";",dec=".")
	# write.table(sys$intermediateVar,file="iv.csv",sep=";",dec=".")
	# 
...
cppRK4 <- function(sys=NULL, times=NULL, parms=NULL, y0=NULL, eventTime=NULL, eventVar=NULL, 
	...
	# write.table(sys$parms,file="sysparms.csv",sep=';',dec=',',col.names = F)
