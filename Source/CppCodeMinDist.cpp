...
x[3] = 181.808 + (t - 0.0) * 25.274 * (t > 0.0) + (t - 1.0) * 2.12900000000002 * (t > 1.0) + (t - 2.0) * -4.96400000000006 * (t > 2.0) + (t - 3.0) * -2.55099999999993 * 
    (t > 3.0) + (t - 4.0) * -0.510999999999967 * (t > 4.0) + (t - 5.0) * 7.33599999999984 * (t > 5.0) + (t - 6.0) * -0.258999999999901 * (t > 6.0) + (t - 7.0) * 
    2.74900000000002 * (t > 7.0) + (t - 8.0) * 5.58599999999996 * (t > 8.0) + (t - 9.0) * -1.01299999999998 * (t > 9.0) + (t - 10.0) * 9.26199999999994 * (t > 10.0) + 
    (t - 11.0) * -13.0849999999999 * (t > 11.0) + (t - 12.0) * 4.06999999999999 * (t > 12.0) + (t - 13.0) * 7.92899999999997 * (t > 13.0) + (t - 14.0) * 0.0 * 
    (t > 14.0);
x[4] = 58.9293709785044 + (t - 0.0) * -0.231446426809022 * (t > 0.0) + (t - 1.0) * 1.55131683717735 * (t > 1.0) + (t - 2.0) * 11.5082060535855 * (t > 2.0) + (t - 3.0) * 
    -7.68129191306862 * (t > 3.0) + (t - 4.0) * -6.02147258389442 * (t > 4.0) + (t - 5.0) * 13.2425757662529 * (t > 5.0) + (t - 6.0) * 1.09871489901499 * (t > 6.0) + 
    (t - 7.0) * 0.18891224361326 * (t > 7.0) + (t - 8.0) * -2.87280990474652 * (t > 8.0) + (t - 9.0) * 10.0225800444496 * (t > 9.0) + (t - 10.0) * -42.8677639901451 * 
    (t > 10.0) + (t - 11.0) * 25.1527380819595 * (t > 11.0) + (t - 12.0) * 1.21978515973824 * (t > 12.0) + (t - 13.0) * 10.1789535626446 * (t > 13.0) + (t - 14.0) * 
    0.0 * (t > 14.0);
x[5] = 0.11355417155774 + (t - 0.0) * -0.033054084777129 * (t > 0.0) + (t - 1.0) * 0.0415263194038875 * (t > 1.0) + (t - 2.0) * 0.0103425444405416 * (t > 2.0) + (t - 3.0) * 
    -0.0397105450413949 * (t > 3.0) + (t - 4.0) * -0.00675614202547543 * (t > 4.0) + (t - 5.0) * 0.0255880359101571 * (t > 5.0) + (t - 6.0) * 0.0140258533436836 * (t > 6.0) + 
    (t - 7.0) * -0.0246351913413347 * (t > 7.0) + (t - 8.0) * 0.00477641393621404 * (t > 8.0) + (t - 9.0) * 0.0197259876516136 * (t > 9.0) + (t - 10.0) * -0.00984795426378968 * 
    (t > 10.0) + (t - 11.0) * -0.00336815210095619 * (t > 11.0) + (t - 12.0) * -0.0111327968318516 * (t > 12.0) + (t - 13.0) * 0.0117129316198268 * (t > 13.0) + (t - 14.0) * 
    0.0 * (t > 14.0);
x[6] = 0.0485 + (t - 0.0) * -0.00369591141396942 * (t > 0.0) + (t - 1.0) * 0.0157970894185144 * (t > 1.0) + (t - 2.0) * 0.0078216948680081 * (t > 2.0) + (t - 3.0) * 
    -0.0766937057454238 * (t > 3.0) + (t - 4.0) * 0.0683146498781182 * (t > 4.0) + (t - 5.0) * -0.00584065196903105 * (t > 5.0) + (t - 6.0) * -0.0185948010888599 * (t > 6.0) + 
    (t - 7.0) * 0.00782555618336622 * (t > 7.0) + (t - 8.0) * 0.0222956760885857 * (t > 8.0) + (t - 9.0) * 0.0138552024761722 * (t > 9.0) + (t - 10.0) * -0.0412784182223997 * 
    (t > 10.0) + (t - 11.0) * -0.00635438585783255 * (t > 11.0) + (t - 12.0) * 0.00740744929997827 * (t > 12.0) + (t - 13.0) * 0.0153617694566264 * (t > 13.0) + (t - 14.0) * 
    0.0 * (t > 14.0);
x[7] = 4.99948675834 + (t - 0.0) * 3.67643900792 * (t > 0.0) + (t - 1.0) * -2.80403383957999 * (t > 1.0) + (t - 2.0) * -5.99644561346 * (t > 2.0) + (t - 3.0) * 
    1.24784310481 * (t > 3.0) + (t - 4.0) * 10.2109481078 * (t > 4.0) + (t - 5.0) * -1.36922195452 * (t > 5.0) + (t - 6.0) * -6.55686079513001 * (t > 6.0) + 
    (t - 7.0) * -0.333190131479981 * (t > 7.0) + (t - 8.0) * 3.73723471201997 * (t > 8.0) + (t - 9.0) * -1.14447329268996 * (t > 9.0) + (t - 10.0) * 1.44839623738996 * 
    (t > 10.0) + (t - 11.0) * -4.26787129506998 * (t > 11.0) + (t - 12.0) * 2.86966295795999 * (t > 12.0) + (t - 13.0) * 8.36311985055005 * (t > 13.0) + (t - 14.0) * 
    0.0 * (t > 14.0);
x[1] = (1.0/(1.0 + exp(-parms[0] * (x[5] - parms[1] - x[6])))) * (parms[3] - parms[2]) + parms[2];
x[2] = (1.0/(1.0 + exp(-parms[4] * (x[5] - parms[5] - x[6])))) * (parms[7] - parms[6]) + parms[6];
x[0] = x[1] * (x[3]) + x[2] * (x[4]) + x[7];
ydot[0] = parms[8] * (x[0] - y[0]);
}
