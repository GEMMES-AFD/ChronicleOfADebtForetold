...
inflation=pDot/p
reserves=(Rfx*en)/GDP
foreignDebt=en*(Bgfx+Lgfx+Lfxfb +Lgfxtr+ Lfxfw+(debtSwapFXBgFX+debtSwapFXLgFX+debtSwapFXLgFXtr)*(1-decds))/GDP
privateDebt =(Ldf + Lfxfb*en + Lfxfw*en+Ldh)/GDP
pubDebt=(Bg+ Bgtr + (Bgfx+Lgfx+Lgfxtr+(debtSwapFXBgFX+debtSwapFXLgFX+debtSwapFXLgFXtr)*(1-decds))*en)/GDP
fiscalDef=FD/GDP
hhFrag=(ilh*Ldh)/Sh
